...
/* +++++++++++++++++++++++ ADDED BY DOUG ^ ++++++++++++++++++++++++++++++++++++++ */	
	...
	function UNIVcalc(name,Phc,Hhcp,Hscr,Hpar,Hpts,hole,PTSid) {
		...
		if ( Hscr != 0 ) {
			...
			if ((Phc>18) && (Phc<37)) {	// <> correct Mar 4: if Phc > 18 but < 2XHhcp still > 2 strokes!
				if (+Hhcp<=(+Phc-18)) {		//if ((Hhcp-18)<=Phc) {
					let alertPhc = Phc-18;
					//IFnote = "in UNIVcalc Phc>18/Hhcp("+Hhcp+")<=(Phc-18) . . .\n{Phc-18 = "+alertPhc+"}";
						//if (hole=="1") {alert("hole = "+hole+"\n\n"+IFnote)};
						//alert("hole = '"+hole+"'\n\n"+IFnote);
			...
			if (Phc>36) {	
				...
				if (+Hhcp<=(+Phc-36)) {		
					let alertPhc = Phc-36;
					/* IFnote = "in UNIVcalc Phc>36/Hhcp("+Hhcp+")<=(Phc-36) . . .\n{Phc-36 = "+alertPhc+"}"+
							 "\n\nPhc = "+Phc+"; Hhcp = "+Hhcp+"; Hscr = "+Hscr+"; Hpar = "+Hpar+"; Hpts = "+Hpts; */
					if (Hscr-3 == Hpar ) {Hpts = 2;} //net par
					else if (Hscr-4 == Hpar ) {Hpts = 1;} //net bogie
					else if (Hscr-2 == Hpar ) {Hpts = 3;} //net birdie
					//else if (Hscr-0 == Hpar ) {Hpts = 4;} //net eagle
						else if (Hscr-1 == Hpar ) {Hpts = 4;} 
						else if (Hscr-0 == Hpar ) {Hpts = 5;} 
					//else if (+Hscr + +0 == Hpar ) {Hpts = 5;} //net double eagle
						else if (+Hscr + +1 == Hpar ) {Hpts = 6;} //net TRP EAGLE (albatross)
					else {Hpts = 0;}	//net ^ bogie:							
					IFnote = "in UNIVcalc Phc>36/Hhcp("+Hhcp+")<=(Phc-36) . . .\n{Phc-36 = "+alertPhc+"}"+
						"\n\nPhc = "+Phc+"; Hscr = "+Hscr+"; Hpar = "+Hpar+";\nHhcp = "+Hhcp+"; Hpts = "+Hpts;
					/* if ((Hscr==4) && (+Hhcp<=(+Phc-36))) {
						alert("Hscr = 4 and +Hhcp<=(+Phc-36)!");
					} */
					
				}
				else {  
					//IFnote = "in UNIVcalc Phc>36/else [Hhcp>Phc-36]!";				
					if (Hscr-2 == Hpar ) {Hpts = 2;} //net par
					else if (Hscr-3 == Hpar ) {Hpts = 1;} //net bogie
					else if (Hscr-1 == Hpar ) {Hpts = 3;} //net birdie
					else if (Hscr-0 == Hpar ) {Hpts = 4;} //net eagle
					else if (+Hscr + +1 == Hpar ) {Hpts = 5;} //net dbl EAGLE 	???
						else if (+Hscr + +2 == Hpar ) {Hpts = 6;} //net TRP EAGLE (albatross).  ???
					else {Hpts = 0;}	//net ^ bogie:		
					IFnote = "in UNIVcalc Phc>36/else [Hhcp>Phc-36]!"+
						"\n\nPhc = "+Phc+"; Hscr = "+Hscr+"; Hpar = "+Hpar+";\nHhcp = "+Hhcp+"; Hpts = "+Hpts;
				}
...
*/		
	...
	function BLURfn(SCRinput) {
		...
		//if (document.getElementById(SCRinput).hasFocus()) {
		//if (document.activeElement === SCRinput) {
			//const holes = new Array();
/*			var emptyINPUT;
			//string.substring(startIndex, [endIndex])
			var p = SCRinput.substring(1,2); var h = SCRinput.substring(3);
			for (var MYh = +h; MYh < 19; MYh++) {	
				for (var MYp = +p; MYp<6; MYp++) {	
					if (document.getElementById("p"+MYp+"h"+MYh).value == "") {
						emptyINPUT = "y";
					}
					else { emptyINPUT = "n" }
				}
			}
*/			//alert("POST 'calcALL()'\n\nSCRinput: "+SCRinput+"; entry = "+entry+"\n\n"+IFnote);	//+"\n\n"+
				//"MYp = "+MYp+"; MYh = "+MYh+"\nemptyINPUT = "+emptyINPUT); // < May 4/26 **
		//}
		...
		var MAXscore;
			...
			if ( document.getElementById(SCRinput).style.background=="purple") {
				STROKES = 3; // < May 3/26 **
			}
			//else { STROKES = 0 }
...
*/		
		/*
		if ( (document.getElementById(SCRinput).style.background=="purple") && (document.getElementById(SCRinput).value>=10) ) {
					document.getElementById(SCRinput).style.fontSize="12px"; 
		}	
		*/
		...
		//alert("SCRinput: "+SCRinput+"; entry = "+entry+"\n\nIFnote (fr 'UNIVcalc()'): "+IFnote); // < May 4/26 **
...
//			}
	...
	function clearSAVED() {
		...
		for (var a = 1; a < 6; a++) {
			...
			localStorage.setItem('Dp'+a+'NAME',"");	
		}
		...
		localStorage.setItem('gDf',""); localStorage.setItem('gDb',""); localStorage.setItem('gDt',"");
		...
		*/		
		...
		if ( STKbtnLBL=="Strokes" ) {
				for (var h = 1; h < 19; h++) {
					...
					if ( (HCpl1-36) >= +HOLEhc) {
						document.getElementById("p1h"+h).style.background = "purple";
						document.getElementById("p1h"+h).style.color = "white";
						//document.getElementById("p1h"+h).maxLength = 2;	// < May 6/26 *
						if ( document.getElementById("PARh"+h).value==5 ) {
							document.getElementById("p1h"+h).maxLength = 2;	// < May 6/26 *
							document.getElementById("p1h"+h).style.width = "22px";
							document.getElementById("p1h"+h).style.height = "22px";
							//document.getElementById("p1h"+h).style.box-sizing = "border-box";	
							document.getElementById("p1h"+h).style.padding = "2px";	
							//document.getElementById("p1h"+h).style.fontSize="12px"; 
							  /*width: 200px;
							  height: 40px;
							  box-sizing: border-box; /* Essential: keeps dimensions fixed */
							  //padding: 5px;
						}
						//document.getElementById("p1h"+h).style.fontSize="12px";
							
						//document.getElementById("p1h"+h).style.width="15px"; 
					}
					else if ( (HCpl1-18) >= +HOLEhc) {
					...
					if ( (HCpl2-36) >= +HOLEhc) { document.getElementById("p2h"+h).style.background = "purple"; document.getElementById("p2h"+h).style.color = "white"; document.getElementById("p2h"+h).maxLength = 2;	}
					else if ( (HCpl2-18) >= +HOLEhc) { document.getElementById("p2h"+h).style.background = "green"; document.getElementById("p2h"+h).style.color = "white"; }
					else if ( +HCpl2 >= +HOLEhc ) { document.getElementById("p2h"+h).style.background = "lime"; }			
					if ( (HCpl3-36) >= +HOLEhc) { document.getElementById("p3h"+h).style.background = "purple"; document.getElementById("p3h"+h).style.color = "white"; document.getElementById("p3h"+h).maxLength = 2; }					
					else if ( (HCpl3-18) >= +HOLEhc) { document.getElementById("p3h"+h).style.background = "green"; document.getElementById("p3h"+h).style.color = "white"; }
					else if ( +HCpl3 >= +HOLEhc ) { document.getElementById("p3h"+h).style.background = "lime"; }
		
					if ( (HCpl4-36) >= +HOLEhc) { document.getElementById("p4h"+h).style.background = "purple"; document.getElementById("p4h"+h).style.color = "white"; document.getElementById("p4h"+h).maxLength = 2;}
					else if ( (HCpl4-18) >= +HOLEhc) { document.getElementById("p4h"+h).style.background = "green"; document.getElementById("p4h"+h).style.color = "white"; }
					else if ( +HCpl4 >= +HOLEhc ) { document.getElementById("p4h"+h).style.background = "lime"; }
		
					if ( (HCpl5-36) >= +HOLEhc) { document.getElementById("p5h"+h).style.background = "purple"; document.getElementById("p5h"+h).style.color = "white"; document.getElementById("p5h"+h).maxLength = 2;}					
					else if ( (HCpl5-18) >= +HOLEhc) { document.getElementById("p5h"+h).style.background = "green"; document.getElementById("p5h"+h).style.color = "white"; }
 ...
 /*        &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& May/23 &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&     */
	...
	function HiLo() {
		...
		if ( which == 1 ) {
			...
			if (document.getElementById('gAf').value==highF) {document.getElementById('gAf').style.background="red"; document.getElementById('gAf').style.color="white"}
			if (document.getElementById('gBf').value==highF) {document.getElementById('gBf').style.background="red"; document.getElementById('gBf').style.color="white"}
			if (document.getElementById('gCf').value==highF) {document.getElementById('gCf').style.background="red"; document.getElementById('gCf').style.color="white"}
			if (document.getElementById('gDf').value==highF) {document.getElementById('gDf').style.background="red"; document.getElementById('gDf').style.color="white"}
			...
			if (document.getElementById('gAb').value==highB) {document.getElementById('gAb').style.background="red"; document.getElementById('gAb').style.color="white"}
			if (document.getElementById('gBb').value==highB) {document.getElementById('gBb').style.background="red"; document.getElementById('gBb').style.color="white"}
			if (document.getElementById('gCb').value==highB) {document.getElementById('gCb').style.background="red"; document.getElementById('gCb').style.color="white"}
			if (document.getElementById('gDb').value==highB) {document.getElementById('gDb').style.background="red"; document.getElementById('gDb').style.color="white"}
			...
			if (document.getElementById('gAt').value==highT) {document.getElementById('gAt').style.background="red"; document.getElementById('gAt').style.color="white"}
			if (document.getElementById('gBt').value==highT) {document.getElementById('gBt').style.background="red"; document.getElementById('gBt').style.color="white"}
			if (document.getElementById('gCt').value==highT) {document.getElementById('gCt').style.background="red"; document.getElementById('gCt').style.color="white"}
			if (document.getElementById('gDt').value==highT) {document.getElementById('gDt').style.background="red"; document.getElementById('gDt').style.color="white"}
		...
		if ( which == 2 ) {			
			...
			if (document.getElementById('gAfAVG').innerHTML==highFav) {document.getElementById('gAfAVG').style.background="red";   document.getElementById('gAfAVG').style.color="white"}
			if (document.getElementById('gBfAVG').innerHTML==highFav) {document.getElementById('gBfAVG').style.background="red";   document.getElementById('gBfAVG').style.color="white"}
			if (document.getElementById('gCfAVG').innerHTML==highFav) {document.getElementById('gCfAVG').style.background="red";   document.getElementById('gCfAVG').style.color="white"}
			if (document.getElementById('gDfAVG').innerHTML==highFav) {document.getElementById('gDfAVG').style.background="red";   document.getElementById('gDfAVG').style.color="white"}
			...
			if (document.getElementById('gAbAVG').innerHTML==highBav) {document.getElementById('gAbAVG').style.background="red";   document.getElementById('gAbAVG').style.color="white"}
			if (document.getElementById('gBbAVG').innerHTML==highBav) {document.getElementById('gBbAVG').style.background="red";   document.getElementById('gBbAVG').style.color="white"}
			if (document.getElementById('gCbAVG').innerHTML==highBav) {document.getElementById('gCbAVG').style.background="red";   document.getElementById('gCbAVG').style.color="white"}
			if (document.getElementById('gDbAVG').innerHTML==highBav) {document.getElementById('gDbAVG').style.background="red";   document.getElementById('gDbAVG').style.color="white"}
			...
			if (document.getElementById('gAtAVG').innerHTML==highTav) {document.getElementById('gAtAVG').style.background="red";   document.getElementById('gAtAVG').style.color="white"}
			if (document.getElementById('gBtAVG').innerHTML==highTav) {document.getElementById('gBtAVG').style.background="red";   document.getElementById('gBtAVG').style.color="white"}
			if (document.getElementById('gCtAVG').innerHTML==highTav) {document.getElementById('gCtAVG').style.background="red";   document.getElementById('gCtAVG').style.color="white"}
			if (document.getElementById('gDtAVG').innerHTML==highTav) {document.getElementById('gDtAVG').style.background="red";   document.getElementById('gDtAVG').style.color="white"}
